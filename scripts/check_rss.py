...
def check_feeds(config: dict, existing_urls: set[str], dry_run: bool = False) -> list[dict]:
...
def main() -> None:
    ...
    # フィード巡回
    articles = check_feeds(config, existing_urls, dry_run=args.dry_run)
